...
int ocelot_init(struct ocelot *ocelot)
{
	...
	for (i = 0; i < ocelot->num_flooding_pgids; i++)
		ocelot_write_rix(ocelot, ANA_FLOODING_FLD_MULTICAST(PGID_MC) |
				 ...
				 ANA_FLOODING, i);
	ocelot_write(ocelot, ANA_FLOODING_IPMC_FLD_MC6_DATA(PGID_UC) |
		     ANA_FLOODING_IPMC_FLD_MC6_CTRL(PGID_UC) |
		     ANA_FLOODING_IPMC_FLD_MC4_DATA(PGID_UC) |
		     ANA_FLOODING_IPMC_FLD_MC4_CTRL(PGID_UC),
		     ANA_FLOODING_IPMC);
