...
static bool imx290_settings_match(struct imx290 *imx290, uint8_t cond)
{
	...
	if (cond & COND_FPS_msk) {
		switch (imx290->fps) {
		case FPS_25: reject |= !(cond & COND_25_FPS); break;
		case FPS_30: reject |= !(cond & COND_30_FPS); break;
		case FPS_50: reject |= !(cond & COND_50_FPS); break;
		case FPS_60: reject |= !(cond & COND_60_FPS); break;
	...
	if (cond & COND_LANES_msk) {
		...
		case 2: reject |= !(cond & COND_2_LANES); break;
		case 4: reject |= !(cond & COND_4_LANES); break;
		default: reject |= true; break;
		}
	}
	...
	if (cond & COND_INCK_msk) {
		switch (imx290->inck) {
		case INCK_37: reject |= !(cond & COND_INCK_74); break;
		case INCK_74: reject |= !(cond & COND_INCK_37); break;
		default: reject |= true; break;
		}
	}
			 ...
			 struct v4l2_streamparm *a)
{
	...
	memset(a->parm.capture.reserved, 0,
	       sizeof a->parm.capture.reserved);
